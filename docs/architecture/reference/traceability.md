...
| 把 Agent 接入 Feishu 消息流 | FeishuChannel、SessionDispatcher、GatewaySupervisor | `docs/prd/20-acp-native-feishu-agent-mvp.md` Story 4–8 | `docs/architecture/10-channel-gateway.md` | `src-tauri/src/services/channels/feishu/`、`src-tauri/src/services/session_dispatcher/`、`src-tauri/src/services/gateway/` |
